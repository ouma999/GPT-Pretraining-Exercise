# -*- coding: utf-8 -*-
"""
PolexOumaOtieno_partE_only.py
Student: Polex Ouma Otieno
This file runs ONLY Part E - the medium model (355M)
"""
...
def trainIt(model, gpt_config, optimizer, settings,
    ...
    torch.save({"model_state_dict": model.state_dict(),
               ...
               "model_and_optimizer_355M.pth")

    return train_losses, val_losses, tokens_seen, model


# ============================================================
# PART E ONLY - Medium (355M) model
# ============================================================
print("\n" + "="*60)
...
print("\nPart E - Generation with pretrained Medium weights ONLY (before fine-tuning):")
token_ids = generate(
    model=gpt_model,
...
print("\n" + "="*60)
print("Part E complete! Plot saved as PartE_medium_loss.png")
print("="*60)
