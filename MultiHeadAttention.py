...
Created on Wed Feb 11 10:45:19 2026
...
class MultiHeadAttention(nn.Module):
    ...
    def forward(self, x):
        ...
        # `context_length`, this will result in errors in the mask creation
        #  further below. 
        # In practice, this is not a problem because the LLM 
        #  ensures that inputs do not exceed
